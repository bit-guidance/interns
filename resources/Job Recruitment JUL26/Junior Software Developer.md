...
* Cloud skills: AWS Lambda development

* S3 storage Experience with AWS (core services, deployment, IAM management, etc.) 
...
* Attend to technical workshops to identify technical requirements

* Define application design and solutions including CI/CD and AWS services identification to be enabled with the support of the infrastructure architect

* Support software developers using standard framework and applying standard design patterns

* Coordinate technical actions and propose technical solutions

* Assist the project manager in coordinating and testing technical actions carried out in project

* Advice the project team on any questions related to technical choices

* Build and improve common technical framework implementation and resources

## Qualifications

* UG: B.Tech / B.E. in Computer Science and Engineering (CSE)
...
| 9 | Delibo| LinkedIn       |Software developer     | https://www.linkedin.com/jobs/search-results/currentJobId=4397628727&eBP=NOT_ELIGIBLE_FOR_CHARGING&refId=a6Pyxn7otC4K3HhZr1XR5g%3D%3D&trackingId=1RqN%2FkFG1l5LJeZyMu5BbA%3D%3D&keywords=Junior%20Jcloudveloper&origin=SEMANTIC_SEARCH_LANDING_PAGE | 
| 10 | StatusNeo| LinkewdIn         | Junior software developer|  https://www.linkedin.com/jobs/view/junior-software-engineer-at-statusneo-4426048234/| 
...
* Common requirements observed: 
  Proficiency in Python, Java, or C++, Knowledge of SQL, Git/GitHub, and version control, Unique requirements identified: Familiarity    with Agile/Scrum development practices, Experience with REST APIs, microservices, or DevOps tools.
 
* Additional observations:
   Most companies prefer candidates with practical project experience and GitHub portfolios, Strong communication skills and the ability to collaborate effectively are frequently mentioned.
